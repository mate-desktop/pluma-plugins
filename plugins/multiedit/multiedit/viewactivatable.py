...
import re, time
import sys
from gi.repository import GLib, GObject, Pango, PangoCairo, Gdk, Gtk, Pluma

from .signals import Signals

class MultiEditViewActivatable(GObject.Object, Pluma.ViewActivatable, Signals):
    ...
    def reset_buffer(self, newbuf):
        ...
        if newbuf == None or not isinstance(newbuf, Pluma.Document):
            return
